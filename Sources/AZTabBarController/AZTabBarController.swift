...
open class AZTabBarController: UIViewController {
  ...
  public var isVisible: Bool {
	...
	*/
	...
	public var buttonsContainer:UIView!
	...
	open func setBadgeText(_ text: String?, atIndex index:Int){
		if let buttons = buttons{
			if index < buttons.count{
				self.notificationBadgeAppearance.distanceFromCenterX = self.notificationBadgeAppearance.distanceFromCenterX ?? 15
				self.notificationBadgeAppearance.distanceFromCenterY = self.notificationBadgeAppearance.distanceFromCenterY ?? -10
